...
const TransferConfirmacaoModal: React.FC<{
    ...
    const isTransferToSelf = clienteId === user?.cliente?.id;
        ...
        <AlertDialog open={isOpen}>
            <AlertDialogContent>
                ...
                <p className='text-[16px] font-[500] text-[#000000] leading-[16px]'>
                    ...
                    <br />
                    {isTransferToSelf
                        ? 'Você assumirá imediatamente a responsabilidade por este item.'
                ...
                <div className='flex flex-col justify-end gap-2'>
                    <Button
                        variant='tertiary'
                        onClick={onConfirm}
                        text={isTransferToSelf ? 'Transferir para mim' : 'De acordo, excluir.'}
                    />
